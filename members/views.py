...
class AddMember(FormView):
    ...
    def form_valid(self, form):
        """Updates registration_upto."""
        temp = form.save(commit=False)
        temp.registration_upto = parser.parse(form.cleaned_data('registration_date')) + delta.relativedelta(months=int(request.POST.get('subscription_period')))
        temp.save()
